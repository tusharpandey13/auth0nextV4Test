...
describe("Transaction Store", async () => {
    describe("get", async () => {
        it("should use the state to return the decrypted cookie", async () => {
            ...
            expect(await transactionStore.get(requestCookies, state)).toEqual(transactionState);
        });
    ...
    describe("save", async () => {
        ...
        it("should throw an error if the transaction does not contain a state", async () => {
            ...
            expect(() => transactionStore.save(responseCookies, transactionState)).rejects.toThrowError();
        });
    ...
    describe("delete", async () => {
        it("should remove the cookie", async () => {
            ...
            expect(responseCookies.get(cookieName)?.expires).toEqual(new Date("1970-01-01T00:00:00.000Z"));
        });
        it("should not throw an error if the cookie does not exist", async () => {
            ...
            expect(transactionStore.delete(responseCookies, "non-existent-state")).resolves.not.toThrow();
        });
    });
});
